...
// Tidied up - starts 1275
// Added force cdloop length/19.5
// Added loopfactor
//
...
void CDAudio_Play(BYTE track,BOOL looping)
{
    ...
    cdloop = cda_trackinfo[track].length / loopfactor;
...
void CDAudio_Update(void )
{
	...
	if (gs.PlayCD)
	{
        ...
        if (cdtic >= cdloop)
        {
            cdtic = 0;
            cda_stop();
            cda_play(cda_trackinfo[playTrack].start,cda_trackinfo[playTrack].start + cda_trackinfo[playTrack].length - 1);
            return;
        }
    }
...
/*
Track:  1 | Length = 13191
Track:  2 | Length = 4945
Track:  3 | Length = 13757
Track:  4 | Length = 16900
Track:  5 | Length = 14835
Track:  6 | Length = 11850
Track:  7 | Length = 15770
Track:  8 | Length = 16193
Track:  9 | Length = 17102
Track: 10 | Length = 18056
Track: 11 | Length = 18891
Track: 12 | Length = 22566
Track: 13 | Length = 11472
Track: 14 | Length = 0
*/
