    ...
    if (keystatus[KEYSC_QUOTE])
        ...
        if (keystatus[KEYSC_RSHIFT] || keystatus[KEYSC_LSHIFT])
            ...
            if (keystatus[KEYSC_1])
                ...
                case 3:
                    ...
                    SPRITE_TAG11(searchwall) =
                        getnumber(tempbuf, SPRITE_TAG11(searchwall), 65536L, 1);
                    break;
                    }
            ...
            if (keystatus[KEYSC_2])
                ...
                case 3:
                    ...
                    SPRITE_TAG12(searchwall) =
                        getnumber(tempbuf, SPRITE_TAG12(searchwall), 65536L, 1);
                    break;
                    }
            ...
            if (keystatus[KEYSC_3])
                ...
                case 3:
					...
					i = getnumber(tempbuf, SPRITE_TAG13(searchwall), 65536L, 1);
            ...
            if (keystatus[KEYSC_4])
                ...
                case 3:
					...
					i = getnumber(tempbuf, SPRITE_TAG14(searchwall), 65536L, 1);
            ...
            if (keystatus[KEYSC_5])
                ...
                case 3:
                    ...
                    SPRITE_TAG15(searchwall) =
                        getnumber(tempbuf, SPRITE_TAG15(searchwall), 65536L, 1);
                    break;
                    }
        ...
        if (keystatus[KEYSC_1])
            ...
            case 4:
                ...
                wall[searchwall].hitag =
                    getnumber(tempbuf, wall[searchwall].hitag, 65536L, 1);
                break;
            case 1:
            case 2:
                strcpy(tempbuf, "Sector tag 1 (hitag): ");
                sector[searchsector].hitag =
                    getnumber(tempbuf, sector[searchsector].hitag, 65536L, 1);
                break;
            case 3:
                strcpy(tempbuf, "Sprite tag 1 (hitag): ");
                SPRITE_TAG1(searchwall) =
                    getnumber(tempbuf, SPRITE_TAG1(searchwall), 65536L, 1);
                break;
                }
        ...
        if (keystatus[KEYSC_2])
            ...
            case 4:
                ...
                wall[searchwall].lotag =
                    getnumber(tempbuf, wall[searchwall].lotag, 65536L, 1);
                break;
            case 1:
            case 2:
                strcpy(tempbuf, "Sector tag 2 (lotag): ");
                sector[searchsector].lotag =
                    getnumber(tempbuf, sector[searchsector].lotag, 65536L, 1);
                break;
            case 3:
                strcpy(tempbuf, "Sprite tag 2 (lotag): ");
                SPRITE_TAG2(searchwall) =
                    getnumber(tempbuf, SPRITE_TAG2(searchwall), 65536L, 1);
                // Find the next lotag
                if (sprite[searchwall].picnum == ST1)
                    {
                    FindNextTag();
        ...
        if (keystatus[KEYSC_3])
            ...
            case 4:
                ...
                wall[searchwall].xpanning =
                    getnumber(tempbuf, wall[searchwall].xpanning, 65536L, 1);
                break;
            case 1:
            case 2:
                strcpy(tempbuf, "Sector tag 3 (ceilingxpanning): ");
                sector[searchsector].ceilingxpanning =
                    getnumber(tempbuf, sector[searchsector].ceilingxpanning, 65536L, 1);
                break;
            case 3:
                strcpy(tempbuf, "Sprite tag 3 (clipdist) : ");
                SPRITE_TAG3(searchwall) =
                    getnumber(tempbuf, SPRITE_TAG3(searchwall), 65536L, 1);
        ...
        if (keystatus[KEYSC_4])
            ...
            case 4:
                ...
                wall[searchwall].ypanning =
                    getnumber(tempbuf, wall[searchwall].ypanning, 65536L, 1);
                break;
            case 1:
            case 2:
                strcpy(tempbuf, "Sector tag 4 (ceilingypanning): ");
                sector[searchsector].ceilingypanning =
                    getnumber(tempbuf, sector[searchsector].ceilingypanning, 65536L, 1);
                break;
            case 3:
                strcpy(tempbuf, "Sprite tag 4 (ang) : ");
                SPRITE_TAG4(searchwall) =
                    getnumber(tempbuf, SPRITE_TAG4(searchwall), 65536L, 1);
                break;
                }
            printmessage("");
            }
        ...
        if (keystatus[KEYSC_5])
            ...
            case 2:
                ...
                sector[searchsector].floorxpanning =
                    getnumber(tempbuf, sector[searchsector].floorxpanning, 65536L, 1);
                break;
            case 3:
                strcpy(tempbuf, "Sprite tag 5 (xvel) : ");
                SPRITE_TAG5(searchwall) =
                    getnumber(tempbuf, SPRITE_TAG5(searchwall), 65536L, 1);
                break;
                }
            printmessage("");
            }
        ...
        if (keystatus[KEYSC_6])
            ...
            case 2:
                ...
                sector[searchsector].floorypanning =
                    getnumber(tempbuf, sector[searchsector].floorypanning, 65536L, 1);
                break;
            case 3:
                strcpy(tempbuf, "Sprite tag 6 (yvel) : ");
                SPRITE_TAG6(searchwall) =
                    getnumber(tempbuf, SPRITE_TAG6(searchwall), 65536L, 1);
                break;
                }
            printmessage("");
            }
        ...
        if (keystatus[KEYSC_7])
            ...
            case 3:
                ...
                SPRITE_TAG7(searchwall) =
                    getnumber(tempbuf, SPRITE_TAG7(searchwall), 65536L, 1);
                break;
                }
            printmessage("");
            }
        ...
        if (keystatus[KEYSC_8])
            ...
            case 3:
                ...
                SPRITE_TAG8(searchwall) =
                    getnumber(tempbuf, SPRITE_TAG8(searchwall), 65536L, 1);
                break;
                }
            printmessage("");
            }
        ...
        if (keystatus[KEYSC_9])
            ...
            case 3:
                ...
                SPRITE_TAG9(searchwall) =
                    getnumber(tempbuf, SPRITE_TAG9(searchwall), 65536L, 1);
                break;
                }
            printmessage("");
            }
        ...
        if (keystatus[KEYSC_0])
            ...
            case 3:
                ...
                SPRITE_TAG10(searchwall) =
                    getnumber(tempbuf, SPRITE_TAG10(searchwall), 65536L, 1);
                break;
                }
            printmessage("");
            }
    ...
    if (keystatus[KEYSC_RSHIFT] || keystatus[KEYSC_LSHIFT])
        ...
        if (keystatus[KEYSC_1])
            ...
            case 3:
                ...
                value = getnumber(tempbuf, value, 65536L, 1);
...
DrawClipBox(short spritenum)
    ...
    if (sprite[spritenum].hitag == SECT_SO_CLIP_DIST)
        {
