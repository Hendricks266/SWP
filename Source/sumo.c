...
BossHealthMeter(void)
                    ...
                    if (i == 0 && !serpwasseen)
                        ...
                        if (!SW_SHAREWARE)
                           ...
                           if (gs.PlayCD)
                              ...
                              CDAudio_Play(ThemeTrack[2], TRUE);
                              }
                           else
                           if (gs.MusicOn)
                              {
                              PlayMusic(ThemeSongs[2]);
                              }
                           }
                        }
                    else
                    if (i == 1 && !sumowasseen)
                        ...
                        if (!SW_SHAREWARE)
                           ...
                           if (gs.PlayCD)
                              ...
                              CDAudio_Stop();
                              //CDAudio_Play(13, TRUE);
                              CDAudio_Play(ThemeTrack[3], TRUE);
                              }
                           else
                           if (gs.MusicOn)
                              {
                              PlayMusic(ThemeSongs[3]);
                              }
                           }
                        }
                    else
                    if (i == 2 && !zillawasseen)
                        ...
                        if (!SW_SHAREWARE)
                           ...
                           if (gs.PlayCD)
                              ...
                              CDAudio_Stop();
                              //CDAudio_Play(13, TRUE);
                              CDAudio_Play(ThemeTrack[4], TRUE);
                              }
                           else
                           if (gs.MusicOn)
                              {
                              PlayMusic(ThemeSongs[4]);
                              }
                           }
                        }
                   }
    ...
    for (i=0; i<3; i++)
        ...
        if (!SW_SHAREWARE)
           {
           if (!CDAudio_Playing() && gs.PlayCD && !triedplay)
              {
              //CDAudio_Play(13, TRUE);
              CDAudio_Play(ThemeTrack[i+2], TRUE);
