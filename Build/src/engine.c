...
// Added faketile for eduke defs.c
// Added defs to stop log errors
// Added TX workaround for mingw 4.4.x
//
			...
			case 1:		// angoff <xx>
				{
					...
					old = spriteext[whichsprite].angoff;
					spriteext[whichsprite].angoff = (short)ang;
					//initprintf("Setting maphack for Sprite: %d | Angle: %d | Old Angle: %d\n", whichsprite, ang, old);
				}
				break;
			case 2:      // notmd
				if (whichsprite < 0) {
